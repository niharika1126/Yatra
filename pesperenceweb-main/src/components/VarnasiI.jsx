...
import mathura from "../assets/mathura.jpg"; // Replace with your main Varanasi image
...
const VaranasiI = () => {
  const [mainImage, setMainImage] = useState(mathura); // Set your default Varanasi image
