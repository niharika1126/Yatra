export default function Publication2() {
  return (
    ...
    <div className="bg-Yellow rounded-lg shadow-lg w-full text-primary h-featuredpublication p-8 flex items-center md:items-start flex-col justify-between">
      ...
      {/* Description of the publication, limited to 5 lines on larger screens using line-clamp */}
      <p className="text-sm md:pr-8 line-clamp-5 text-center md:text-left">
        Discover how we are leveraging cutting-edge technology to address the
        world&apos;s most pressing issues. Our commitment to sustainability and
        inclusivity drives every decision we make. Discover how we are
        leveraging cutting-edge technology to address the world&apos;s most
        pressing issues. Our commitment to sustainability and inclusivity drives
