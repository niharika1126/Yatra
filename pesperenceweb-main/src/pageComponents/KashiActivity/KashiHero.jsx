  ...
  return (
    <div className="bg-white py-16 px-4 md:px-20 max-w-7xl mx-auto text-center">
      ...
      >
        ...
        <span className="text-red-800 font-bold">Kashi Day Experience</span>
      </motion.div>
      ...
      >
        “Experience the essence of Kashi – the city of light – in just one transformative day.”
      </motion.p>
    </div>
  );
};

export default KashiHero;
