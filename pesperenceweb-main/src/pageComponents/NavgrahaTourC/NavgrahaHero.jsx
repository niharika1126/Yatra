  ...
  return (
    <div className="bg-white py-16 px-4 md:px-20 max-w-7xl mx-auto text-center">
      ...
      >
        ...
        <span className="text-red-800 font-bold">Navgraha Temple Tour</span>
      </motion.div>
      ...
      >
        Navgraha Temple Tour: Cosmic Pilgrimage
      </motion.h1>
      ...
      >
        “Align your spiritual path with celestial forces at India’s most sacred Navgraha temples.”
      </motion.p>
    </div>
  );
};

export default NavgrahaHero;
