...
export default function Header() {
  return (
    ...
    <section className="w-full bg-primary text-white py-6 px-4 md:px-16 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-4 xl:gap-44 relative">
      ...
      {/* Image of a money, with responsive width settings */}
      <img src={money} alt="money" className="w-full max-w-xs md:max-w-sm" />
