...
export default function Achievements() {
  return (
    <section className="w-mainwidth flex flex-col items-center gap-4 text-black">
      ...
      <p className="text-4xl font-bold">Persperence</p>

      {/* Description text for the section */}
      <p className="text-base text-center w-11/12 lg:w-9/12">
        Persperance bridges the gap between groundbreaking research and global
        ...
        individual researchers, and citizen scientists. Beyond this, Persperance
